...
| Lab 1 and Lab 2 drafts | `docs/assignments/lab-01/draft.md` (Sept 4–5) and `docs/assignments/lab-02/draft.md` (Sept 6) — each run end to end in ArcGIS Pro 3.7.1 with every figure re-shot; unlinked from the nav. The plan for bringing Lab 2 up to Lab 1's depth (sensitivity step, exposed threshold, imagery metadata, rubric re-split) is `tools/lab02/PARITY_PLAN.md` |
