...
<div class="columns" style="grid-template-columns: auto 1fr; align-items:center;">
<div>

<svg viewBox="0 0 1400 1244" style="display:block;height:500px;" xmlns="http://www.w3.org/2000/svg" font-family="Avenir Next, Segoe UI, Helvetica, Arial, sans-serif">
<image href="images/rs-arcgis-band-red.jpg" x="0" y="0" width="1400" height="1244"/>
<line x1="190" y1="990" x2="95" y2="935" stroke="#ffffff" stroke-width="10"/>
<line x1="190" y1="990" x2="95" y2="935" stroke="#8b1a1a" stroke-width="5"/>
<circle cx="95" cy="935" r="12" fill="#8b1a1a" stroke="#ffffff" stroke-width="4"/>
<rect x="190" y="990" width="560" height="118" rx="12" fill="#ffffff" stroke="#8b1a1a" stroke-width="5"/>
<text x="470.0" y="1040" font-size="42" font-weight="700" fill="#8b1a1a" text-anchor="middle">Farm fields: dark</text>
<text x="470.0" y="1086" font-size="34" fill="#22262e" text-anchor="middle">reflectance 0.06</text>
<line x1="190" y1="368" x2="80" y2="400" stroke="#ffffff" stroke-width="10"/>
<line x1="190" y1="368" x2="80" y2="400" stroke="#8b1a1a" stroke-width="5"/>
<circle cx="80" cy="400" r="12" fill="#8b1a1a" stroke="#ffffff" stroke-width="4"/>
<rect x="190" y="250" width="560" height="118" rx="12" fill="#ffffff" stroke="#8b1a1a" stroke-width="5"/>
<text x="470.0" y="300" font-size="42" font-weight="700" fill="#8b1a1a" text-anchor="middle">Bare ground: bright</text>
<text x="470.0" y="346" font-size="34" fill="#22262e" text-anchor="middle">reflectance 0.17</text>
</svg>

</div>
<div style="font-size:0.84em;">

- One Landsat 8 scene of **Utah Lake**, shown **one band at a time**
- This band: **0.64–0.67 µm**, red
- Healthy crops are **dark**: chlorophyll absorbs red
- Dry, bare ground is **bright**: nearly three times the fields

</div>
</div>

<!-- Three slides, one scene, three bands, all drawn in ArcGIS Pro with the SAME grayscale stretch,
so a brighter pixel really did reflect more light. Set the pattern here: a "band" is one wavelength
window, stored as its own grid of numbers, one sheet from the last slide.

The scene is the Lab 2 scene: Landsat 8 OLI, LC08_L2SP_038032_20250712_02_T1 (path 38, row 32,
12 July 2025), Collection 2 Level-2 surface reflectance, clipped to Utah Lake, Provo, and Orem. The
circles at the lower left are center-pivot fields west of the lake. Band 4 is the red half of the
NDVI they computed in Lab 2.

The labeled numbers are surface reflectance (fraction of sunlight reflected, 0 to 1), sampled from
the band rasters: a center-pivot field 0.06, bare ground on the west side 0.17. The stretch is
digital number 7,700 to 18,800 (reflectance about 0.01 to 0.32) on all three visible bands. Band
images rendered by ArcGIS Pro from C:\Ames\Week04\RemoteSensing.aprx
(tools/week04_arcgis_project.py and tools/week04_arcgis_render.py). -->
...
<svg viewBox="0 0 1400 1244" style="display:block;height:500px;" xmlns="http://www.w3.org/2000/svg" font-family="Avenir Next, Segoe UI, Helvetica, Arial, sans-serif">
<image href="images/rs-arcgis-band-green.jpg" x="0" y="0" width="1400" height="1244"/>
<line x1="400" y1="700" x2="400" y2="560" stroke="#ffffff" stroke-width="10"/>
<line x1="400" y1="700" x2="400" y2="560" stroke="#1e6b3a" stroke-width="5"/>
<circle cx="400" cy="560" r="12" fill="#1e6b3a" stroke="#ffffff" stroke-width="4"/>
<rect x="170" y="700" width="560" height="118" rx="12" fill="#ffffff" stroke="#1e6b3a" stroke-width="5"/>
<text x="450.0" y="750" font-size="42" font-weight="700" fill="#1e6b3a" text-anchor="middle">Utah Lake: brightest here</text>
<text x="450.0" y="796" font-size="34" fill="#22262e" text-anchor="middle">0.16: algae and silt</text>
<line x1="190" y1="990" x2="95" y2="935" stroke="#ffffff" stroke-width="10"/>
<line x1="190" y1="990" x2="95" y2="935" stroke="#1e6b3a" stroke-width="5"/>
<circle cx="95" cy="935" r="12" fill="#1e6b3a" stroke="#ffffff" stroke-width="4"/>
<rect x="190" y="990" width="560" height="118" rx="12" fill="#ffffff" stroke="#1e6b3a" stroke-width="5"/>
<text x="470.0" y="1040" font-size="42" font-weight="700" fill="#1e6b3a" text-anchor="middle">Fields: a bit brighter</text>
<text x="470.0" y="1086" font-size="34" fill="#22262e" text-anchor="middle">0.08, up from 0.06</text>
</svg>

</div>
<div style="font-size:0.84em;">

- Same scene, same stretch, **different band**: 0.53–0.59 µm
- What changed from the red band, and what did not?
- The lake lit up: **algae and suspended silt** reflect green
- Fields brighten a little: the "green" in green plants

</div>
</div>

<!-- Ask the class what changed before you say anything. Only the labels that changed are on this
slide: Utah Lake at 0.16 (0.10 in red) and the pivot field at 0.08 (0.06 in red). Utah Lake is
shallow and turbid, and in July it carries algae, which is why the water is brighter in green than
in any other band. Plants reflect a little more green than red or blue, which is why they look
green, but far less than they reflect in the near-infrared (two slides on). -->
...
<svg viewBox="0 0 1400 1244" style="display:block;height:500px;" xmlns="http://www.w3.org/2000/svg" font-family="Avenir Next, Segoe UI, Helvetica, Arial, sans-serif">
<image href="images/rs-arcgis-band-blue.jpg" x="0" y="0" width="1400" height="1244"/>
<line x1="820" y1="720" x2="800" y2="660" stroke="#ffffff" stroke-width="10"/>
<line x1="820" y1="720" x2="800" y2="660" stroke="#1f4fa0" stroke-width="5"/>
<circle cx="800" cy="660" r="12" fill="#1f4fa0" stroke="#ffffff" stroke-width="4"/>
<rect x="820" y="720" width="560" height="118" rx="12" fill="#ffffff" stroke="#1f4fa0" stroke-width="5"/>
<text x="1100.0" y="770" font-size="42" font-weight="700" fill="#1f4fa0" text-anchor="middle">Provo Bay: darkest</text>
<text x="1100.0" y="816" font-size="34" fill="#22262e" text-anchor="middle">reflectance 0.03</text>
<line x1="190" y1="368" x2="80" y2="400" stroke="#ffffff" stroke-width="10"/>
<line x1="190" y1="368" x2="80" y2="400" stroke="#1f4fa0" stroke-width="5"/>
<circle cx="80" cy="400" r="12" fill="#1f4fa0" stroke="#ffffff" stroke-width="4"/>
<rect x="190" y="250" width="560" height="118" rx="12" fill="#ffffff" stroke="#1f4fa0" stroke-width="5"/>
<text x="470.0" y="300" font-size="42" font-weight="700" fill="#1f4fa0" text-anchor="middle">Bare ground: dimmer</text>
<text x="470.0" y="346" font-size="34" fill="#22262e" text-anchor="middle">0.10, down from 0.17</text>
</svg>

</div>
<div style="font-size:0.84em;">

- 0.45–0.51 µm. Almost everything is **dimmer** in blue
- **Provo Bay** is the darkest water in the scene
- Stack red, green, and blue and you get a **natural-color** image
- Swap a different band into the red channel and you get a **false-color** image

</div>
</div>

<!-- Same scene again, blue band, same stretch. Bare ground falls to 0.10 (0.17 in red), and Provo
Bay, the darker lobe on the east side of the lake, is the darkest water at 0.03. Blue is also the
band the atmosphere scatters most, which is why it is the band most affected by haze and smoke;
that comes back in the wildfire slide. The next slide is the band that makes vegetation obvious. -->
...
<svg viewBox="0 0 1400 1244" style="display:block;height:500px;" xmlns="http://www.w3.org/2000/svg" font-family="Avenir Next, Segoe UI, Helvetica, Arial, sans-serif">
<image href="images/rs-arcgis-band-nir.jpg" x="0" y="0" width="1400" height="1244"/>
<line x1="190" y1="990" x2="95" y2="935" stroke="#ffffff" stroke-width="10"/>
<line x1="190" y1="990" x2="95" y2="935" stroke="#6b2a8b" stroke-width="5"/>
<circle cx="95" cy="935" r="12" fill="#6b2a8b" stroke="#ffffff" stroke-width="4"/>
<rect x="190" y="990" width="560" height="118" rx="12" fill="#ffffff" stroke="#6b2a8b" stroke-width="5"/>
<text x="470.0" y="1040" font-size="42" font-weight="700" fill="#6b2a8b" text-anchor="middle">Fields flip: brightest</text>
<text x="470.0" y="1086" font-size="34" fill="#22262e" text-anchor="middle">reflectance 0.48</text>
<line x1="400" y1="700" x2="400" y2="560" stroke="#ffffff" stroke-width="10"/>
<line x1="400" y1="700" x2="400" y2="560" stroke="#6b2a8b" stroke-width="5"/>
<circle cx="400" cy="560" r="12" fill="#6b2a8b" stroke="#ffffff" stroke-width="4"/>
<rect x="170" y="700" width="560" height="118" rx="12" fill="#ffffff" stroke="#6b2a8b" stroke-width="5"/>
<text x="450.0" y="750" font-size="42" font-weight="700" fill="#6b2a8b" text-anchor="middle">Water: black</text>
<text x="450.0" y="796" font-size="34" fill="#22262e" text-anchor="middle">reflectance 0.01</text>
</svg>

</div>
<div style="font-size:0.84em;">

- 0.85–0.88 µm, just past what your eye can see
- Crops **flip**: dark in red, **brightest** here
- Water absorbs near-infrared, so the lake goes **black**
- Red and near-infrared together are the NDVI you computed in **Lab 2**

</div>
</div>

<!-- The pivot field that was 0.06 in red is 0.48 here: healthy leaves scatter near-infrared
strongly, which is exactly what NDVI = (NIR - Red) / (NIR + Red) measures. The lake is 0.01.

Caution on the stretch: this band is drawn with its own stretch (digital number 7,000 to 26,300,
reflectance about 0.0 to 0.52). On the stretch the visible bands share, every field and hillside
saturated to white. Compare the labeled reflectance numbers across slides, not the brightness. -->
...
<div><img src="images/rs-arcgis-eiffel-red.jpg" style="width:100%;"><br><span style="color:#c0392b;">Red band, 0–255</span></div>
<div><img src="images/rs-arcgis-eiffel-green.jpg" style="width:100%;"><br><span style="color:#1e8449;">Green band, 0–255</span></div>
...
# The same split in ArcGIS Pro

<div style="display:grid;grid-template-columns:0.95fr 1fr 1.25fr;gap:0.7em;align-items:start;">
<div style="font-size:0.55em;text-align:center;"><img src="images/rs-arcgis-eiffel-symbology.png" style="width:100%;border:1px solid #c8ccd2;"><br><b>Symbology pane</b>, red band layer</div>
<div style="font-size:0.55em;text-align:center;"><img src="images/rs-arcgis-eiffel-screen-blend.jpg" style="width:100%;border:1px solid #c8ccd2;"><br><b>All three on, Layer Blend = Screen</b></div>
...
<!-- Optional: skip this slide if time is short, or do it live instead (about two minutes, project
C:\Ames\Week04\RemoteSensing.aprx, map Eiffel, saved with the three layers blended).

Why the recombination is exact: each layer has light in only one channel, and Screen combines
layers channel by channel, so red + green + blue layers give back R, G, B. Checked in ArcGIS Pro
3.7.1: the two-color ramp is set in the Color Scheme Editor (Color scheme dropdown → Color scheme
...
<div><img src="images/rs-arcgis-snow-red.jpg" style="width:100%;"><br><span style="color:#c0392b;">Red band</span></div>
<div><img src="images/rs-arcgis-snow-green.jpg" style="width:100%;"><br><span style="color:#1e8449;">Green band</span></div>
...
<div><img src="images/rs-arcgis-smoke-red.jpg" style="width:100%;"><br><span style="color:#c0392b;">Red band</span></div>
<div><img src="images/rs-arcgis-smoke-green.jpg" style="width:100%;"><br><span style="color:#1e8449;">Green band</span></div>
...
<div><img src="images/rs-arcgis-night-red.jpg" style="width:100%;"><br><span style="color:#c0392b;">Red band</span></div>
<div><img src="images/rs-arcgis-night-green.jpg" style="width:100%;"><br><span style="color:#1e8449;">Green band</span></div>
<div><img src="images/rs-arcgis-night-blue.jpg" style="width:100%;"><br><span style="color:#1f5fbf;">Blue band</span></div>
</div>
...
| **MODIS** on Terra & Aqua (NASA), retiring | 250 m to 1 km | 36 | 1 to 2 days |
| **VIIRS** on NOAA-20 & NOAA-21 (NOAA / NASA) | 375 m or 750 m | 22 | daily |
...
MODIS status (checked 2026-09-23, NASA Earthdata "Transition from MODIS to VIIRS"): Terra and Aqua
are still delivering but drifting from their orbits, and NASA says both platforms begin shutting
down in late 2026 or early 2027. VIIRS takes over daily global imaging; Suomi NPP data delivery
ends 1 November 2026, so the table names NOAA-20 and NOAA-21. There is no planned successor for
Terra's morning overpass. VIIRS: 16 moderate bands at 750 m, 5 imagery bands at 375 m, and a
day/night band (the source of most "Earth at night" imagery). The WorldView-3 band
