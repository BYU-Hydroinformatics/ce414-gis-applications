...
DECKS = [
    ...
    (3,  "raster-analysis-map-algebra",    "Raster Analysis and Map Algebra",            "Rasters as grids of numbers, map algebra cell by cell, the four things that must line up, the integer trap, and NDVI built up from the red edge to the Lab 2 model; then local, focal, zonal and global functions."),
    (3,  "raster-hands-on",                "Raster Analysis Hands-On",                   "Four exercises in ArcGIS Pro on the Lab 2 data: the integer trap, a Con() threshold sweep, Focal Statistics at a field edge, and Zonal Statistics by city."),
