...
your work. You are responsible for every number, field name, and claim you submit.

## To be written

- [ ] Permitted uses (concept explanation, debugging, code and expression help)
- [ ] Required disclosure format
- [ ] Prohibited uses
- [ ] How AI use interacts with the model-building and report deliverables
