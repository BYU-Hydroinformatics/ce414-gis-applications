...
![Elevation raster of Big Southern Butte, the butte rising in warm tones out of the flat green Snake River Plain](images/lab08-butte-raster-elevation.png)
...
![Grayscale elevation raster of the butte with a red polygon digitized around the base of the landform](images/lab08-butte-boundary-polygon.png)
...
![Grayscale elevation raster with a cyan rectangle drawn well outside the butte, defining the area where random points will be generated](images/lab08-points-boundary-polygon.png)
...
![Mosaic To New Raster tool dialog in ModelBuilder, with two input rasters, output location Lab 8 - Big Southern Butte.gdb, spatial reference NAD_1983_UTM_Zone_12N, and cell size 30](images/lab08-mosaic-to-new-raster.png)

![Project Raster tool dialog in ModelBuilder with output coordinate system NAD_1983_UTM_Zone_12N, nearest neighbor resampling, and an output cell size of 30 by 30](images/lab08-project-raster.png)
...
![Create Random Points tool dialog with output feature class Random_Points, constraining feature class Points_Boundary, and number of points set to 1000, beside the corresponding model nodes](images/lab08-create-random-points.png)
...
![Extract Values to Points tool dialog with Random_Points as the input point features and Butte Raster Combined as the input raster, producing a Points with Values output](images/lab08-extract-values-to-points.png)
...
![IDW tool dialog with Not Butte Points as input, RASTERVALU as the Z value field, and a variable search radius, beside model nodes running Points with Values through Erase to IDW and a Snake Plain Surface output](images/lab08-erase-and-idw.png)
...
![Extract by Mask tool dialog with Snake Plain Surface as the input raster and Butte_Boundary as the mask, beside two parallel Extract by Mask branches in the model producing Extract Snake Plain Raster and Extract Butte Raster](images/lab08-extract-by-mask.png)
...
![Raster Calculator tool dialog in ModelBuilder showing the map algebra expression subtracting the extracted plain raster from the extracted butte raster, multiplied by 30 by 30 and divided by 1000 cubed](images/lab08-raster-calculator.png)
...
![Model nodes showing Extract Snake Plain Raster and Extract Butte Raster feeding the Raster Calculator, whose Butte Minus Plain Values output feeds Zonal Statistics to produce the final Butte Volume raster](images/lab08-zonal-statistics.png)
...
![Example student layout titled Calculating the Volume of the Big Southern Butte: an imagery map with the red Butte_Boundary polygon, a 3D perspective view of the butte, a locator inset, a legend, and a reported butte volume of 4.0 to 6.0 kilometers cubed](images/lab08-example-results-map.png)
...
images renamed from fig-NN:
  fig-01.png -> lab08-butte-raster-elevation.png
  fig-02.jpg -> lab08-big-southern-butte-photo.jpg
  fig-03.png -> lab08-complete-model-overview.png
  fig-04.png -> lab08-butte-boundary-polygon.png
  fig-05.png -> lab08-points-boundary-polygon.png
  fig-06.png -> lab08-mosaic-to-new-raster.png
  fig-07.png -> lab08-project-raster.png
  fig-08.png -> lab08-create-random-points.png
  fig-09.png -> lab08-extract-values-to-points.png
  fig-10.png -> lab08-erase-and-idw.png
  fig-11.png -> lab08-extract-by-mask.png
  fig-12.png -> lab08-raster-calculator.png
  fig-13.png -> lab08-zonal-statistics.png
  fig-14.png -> lab08-example-results-map.png
  (the placeholder .gitkeep file was deleted; no image was dropped — all 14 are referenced)
stale/unverified screenshots:
  lab08-complete-model-overview.png — illegible at page width; needs re-export from ModelBuilder, not a re-screenshot. Also shows "Lab 8 - Big Southern Butte.gdb".
  lab08-mosaic-to-new-raster.png — shows "Lab 8 - Big Southern Butte.gdb" (pre-renumbering).
  lab08-create-random-points.png — shows "Lab 8 - Big Southern Butte.gdb (2)" (pre-renumbering).
  ...
  lab08-example-results-map.png — the example map's legend reports "4.0 - 6.0 kilometers cubed" while the handout text states a 3.0 to 6.0 km3 range; the image was not altered.
TODO(instructor):
