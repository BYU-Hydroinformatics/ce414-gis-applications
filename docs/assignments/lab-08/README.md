...
> `Labs/Lab 8 - Practicing with Interpolation.docx` in the course folder. This page is a placeholder so the
...
Compare interpolation methods on the same sample points and evaluate which assumptions each one makes.

## Tools introduced

IDW, Kriging, Spline, cross-validation
