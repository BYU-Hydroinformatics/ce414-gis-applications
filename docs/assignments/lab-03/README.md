...
> `Labs/Lab 3 - Georectifying and Digitizing Images.docx` in the course folder. This page is a placeholder so the
...
Georeference a scanned historical map against modern imagery, assess residuals, then digitize features from it.

## Tools introduced

Georeference tab, control points, transformation, editing
