...
![Map view after Fit to Display: the semi-transparent 1893 Escondido topographic sheet sits roughly over the modern imagery basemap of coastal San Diego County](images/lab03-fit-to-display.jpg)
...
![The historic topographic sheet displayed semi-transparently over the modern basemap near San Marcos, California, where road intersections and named landmarks can be matched between the two](images/lab03-control-point-example.jpg)
