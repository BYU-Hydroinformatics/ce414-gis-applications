...
> `Labs/Lab 7 - Big Southern Butte.docx` in the course folder. This page is a placeholder so the
...
Terrain and volume analysis on an isolated volcanic feature, including surface generation and cut/fill reasoning.

## Tools introduced

Project Raster, Create Random Points, Extract Values to Points, IDW, Extract by Mask
