...
> `Labs/Lab 9 - Wind Farm Site Selection.docx` in the course folder. This page is a placeholder so the
...
Multi-criteria raster suitability with explicit hard exclusions, weighted preferences, and a sensitivity comparison.

## Tools introduced

Reclassify, Weighted Sum, Polygon to Raster, Raster to Point
