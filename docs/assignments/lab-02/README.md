...
> `Labs/Lab 2 - NDVI.docx` in the course folder. This page is a placeholder so the
...
Band math on multispectral imagery to map vegetation vigour, with attention to sensor band designations and acquisition conditions.

## Tools introduced

Raster Calculator, band selection, symbology
