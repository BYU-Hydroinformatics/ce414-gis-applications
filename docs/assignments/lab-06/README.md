...
> `Labs/Lab 6 - Avalanche Hazard.docx` in the course folder. This page is a placeholder so the
...
Terrain-driven hazard screening combining slope, aspect, and elevation, distinguishing susceptibility from hazard and risk.

## Tools introduced

Slope, Aspect, Reclassify, Weighted Overlay
