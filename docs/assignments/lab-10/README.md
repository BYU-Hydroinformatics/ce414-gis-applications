...
> `Labs/Lab 10 - Least Cost Path Power Line Analysis.docx` in the course folder. This page is a placeholder so the
...
Build a cost surface from weighted criteria and route a transmission line across it, testing an alternative weighting.

## Tools introduced

Distance Accumulation, Optimal Path As Line, Reclassify
