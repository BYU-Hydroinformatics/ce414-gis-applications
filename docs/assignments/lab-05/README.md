...
> `Labs/Lab 5 - Watershed Delineation.docx` in the course folder. This page is a placeholder so the
...
Hydrologic conditioning and delineation from a DEM: fill, flow direction, flow accumulation, pour points, watershed.

## Tools introduced

Fill, Flow Direction, Flow Accumulation, Watershed, Stream to Feature
