...
> `Labs/Lab 4 - Cell Phone Tower Placement.docx` in the course folder. This page is a placeholder so the
...
Kernel density and terrain screening to place towers where demand is high and coverage is feasible.

## Tools introduced

Kernel Density, Raster Calculator, Con, Slope
